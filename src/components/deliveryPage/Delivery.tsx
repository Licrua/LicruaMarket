...
// import AddressAutocomplete from '@/components/deliveryPage/AddressAutocomplete'
...
//                       Ростов-на-Дону,{' '}
//                       <span className="font-bold">ул. Мечникова 77Б</span>
//                     </span>
//                   </label>
...
//                       checked={
//                         pickupLocation === 'Ростов-на-Дону, Юфимцева 14/2'
//                       }
//                       onChange={(e) => setPickupLocation(e.target.value)}
//                       className="form-radio h-5 w-5 text-blue-600"
//                     />
//                     <span className="ml-3 text-lg font-medium">
//                       Ростов-на-Дону,{' '}
//                       <span className="font-bold">ул. Юфимцева 14/2</span>
//                     </span>
//                   </label>
//                 </div>
//               )}
...
import { useProductStore } from '@/storage/ProductStore'
import { useEffect, useState } from 'react'
// import PurchaseProcess from '../generalComponents/PurchaseProcess'
